...
class GFHANNANSMS_Pro_Settings {
	...
	public static function tooltips( $tooltips ) {
		...
		$tooltips["admin_default"] = __( "You can set several numbers. Separate with commas(,). for example : +905528902922,+905528902922. this numbers is default and you can change them later.", "GF_SMS" );
